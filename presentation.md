...
## Γ' ΓΕΝΙΚΟΥ ΛΥΚΕΙΟΥ ΑΡΓΟΥΣ ΟΡΕΣΤΙΚΟΥ
...
- [Παράδειγμα](books/22-0203.pdf#page=18)
- [Δραστηριότητα ΔΤ5](books/22-0204.pdf#page=12)
...
[Δραστηριότητα ΔΤ1](books/22-0204.pdf#page=11)
...
- [Παράδειγμα 3](books/22-0203.pdf#page=22)
- [Παράδειγμα 1](books/22-0204.pdf#page=9)
- [Δραστηριότητα ΔΤ3](books/22-0204.pdf#page=12)
- [Δραστηριότητα ΔΣ2](books/22-0204.pdf#page=13)
- [2013 Επαναληπτικές / Α2][themata_epan_2013]
...
[2012 Επαναληπτικές / Α4][themata_epan_2012]
...
- [Παράδειγμα](books/22-0203.pdf#page=77)
- [Δραστηριότητα ΔΤ4](books/22-0204.pdf#page=39)
...
[Λύσεις](books/22-0259.pdf#page=10)
...
[Λύσεις](books/22-0259.pdf#page=11)
---
...
### ΠΡΟΣΟΧΗ! Περίπτωση αρνητικών

Το διδακτικό πακέτο ορίζει τους τελεστές `DIV`, `MOD` οι οποίοι αποτελούν το πηλίκο και το υπόλοιπο της ευκλείδιας διαίρεσης δυο ακεραίων αριθμών. 

Έτσι, `7 MOD 3 = 1` και `7 DIV 3 = 2`

Ωστόσο, δεν ξεκαθαρίζεται ποια είναι η ακριβής λειτουργία τους και τι θα συμβεί στις περιπτώσεις που οι εμπλέκονται αρνητικοί αριθμοί.

Στην Ευκλείδια διαίρεση (Μαθηματικά Β΄ Λυκείου παρ. 4.1) ισχύουν:   

- `α = κβ + υ`
- `0 <= υ < |β|`

όπου `α` διαιρετέος, `β` διαιρέτης , `κ` πηλίκο και `υ` υπόλοιπο.
...
- Έστω λοιπόν `α= -92` με τον `β= 5` και θέλω να βρω το `-92 DIV 5` και το `-92 MOD 5`. 

Από τη διαίρεση του `92` με τον `5` έχουμε `92 = 5*18+2`. Επομένως 
```
-92 = -5*18-2 = -5*18-5+5-2 = -5*19+3 = 5(-19)+3
```
Άρα, `-92 = 5(-19)+3` με `0 <= 3 < |5|` που σημαίνει ότι το πηλίκο της διαίρεσης (DIV) του `-92` με τον `5` είναι `-19` και το υπόλοιπο (MOD) είναι `3`.

---

- Έστω τώρα πως `α= -92` με τον `β= -5` και θέλω να βρω το `-92 DIV -5` και το `-92 MOD -5`. 
...
- Έστω τέλος πως `α= 92` με τον `β= -5` και θέλω να βρω το `92 DIV -5` και το `92 MOD -5`. 

Από τη διαίρεση του `92` με τον `5` έχουμε `92 = 5*18+2`. Επομένως 
```
-92 = (-5)(-18)+2 
```
Άρα, `-92 = (-5)(-18)+2` με `0 <= 2 < |-5|` που σημαίνει ότι το πηλίκο της διαίρεσης (DIV) του `92` με τον `-5` είναι `-18` και το υπόλοιπο (MOD) είναι `2`.

Πρέπει να τονιστεί ότι θεωρείται μικρή η πιθανότητα να χρειαστούν τέτοιοι εξεζητημένοι υπολογισμοί στις Πανελλαδικές εξετάσεις.
...
[Λύσεις](books/22-0259.pdf#page=13)
...
[Λύσεις](books/22-0259.pdf#page=16)
...
[Λύσεις](books/22-0259.pdf#page=15)
...
> Υπολογίζεται η τιμή της έκφρασης και εκτελούνται οι εντολές που ανήκουν στην αντίστοιχη περίπτωση τιμών. 
>
> Αν η τιμή της έκφρασης δεν αντιστοιχεί σε καμία περίπτωση, τότε εκτελούνται οι εντολές αλλιώς.
...
> Κατά την εκτέλεση της εντολής υπολογίζεται η τιμή της έκφρασης και στη συνέχεια εκτελούνται οι εντολές που ανήκουν στην αντίστοιχη περίπτωση τιμών. 
>
> Στην περίπτωση που η τιμή έκφρασης δεν αντιστοιχεί σε καμία περίπτωση, τότε εκτελούνται οι εντολές της `ΠΕΡΙΠΤΩΣΗ_ΑΛΛΙΩΣ`. 
>
> Η `ΠΕΡΙΠΤΩΣΗ_ΑΛΛΙΩΣ` είναι προαιρετική. Η εκτέλεση του προγράμματος συνεχίζεται με την εντολή που ακολουθεί μετά το `ΤΕΛΟΣ_ΕΠΙΛΟΓΩΝ`.
...
> Η τρίτη βασική δομή είναι η <u>δομή επανάληψης</u>, ο βρόχος, η οποία επιτρέπει την εκτέλεση εντολών περισσότερες από μία φορά. 
> 
...
> - την εντολή `ΓΙΑ`, με την οποία ο βρόχος επαναλαμβάνεται για προκαθορισμένο αριθμό επαναλήψεων.
...
> Η λειτουργία της εντολής είναι η εξής: Επαναλαμβάνεται η εκτέλεση των εντολών, όσο η συνθήκη είναι αληθής. 
>
> Όταν η συνθήκη γίνει ψευδής, τότε ο αλγόριθμος συνεχίζεται με την εντολή που ακολουθεί το `ΤΕΛΟΣ_ΕΠΑΝΑΛΗΨΗΣ`.
...
> <u>Η γενικότερη δομή επανάληψης</u> υλοποιείται στη ΓΛΩΣΣΑ με την εντολή `ΟΣΟ…ΕΠΑΝΑΛΑΒΕ`. 
>
> Σε αυτή, <u>η συνθήκη που ελέγχει την επανάληψη βρίσκεται στην αρχή της επανάληψης</u> και ο βρόχος επαναλαμβάνεται συνεχώς, όσο η συνθήκη αυτή ισχύει. 
>
> Με τη δομή αυτή μπορούν να εκφραστούν όλες οι επαναλήψεις και γι’ αυτό η εντολή `ΟΣΟ…ΕΠΑΝΑΛΑΒΕ` <u>είναι η σημαντικότερη από όλες τις εντολές επανάληψης</u>. 
>
...
>
> Στη συνέχεια ελέγχεται πάλι η συνθήκη και αν ισχύει, εκτελούνται πάλι οι ίδιες εντολές. 
>
> Όταν η λογική έκφραση γίνει `Ψευδής`, τότε σταματάει η επανάληψη και εκτελείται η εντολή μετά το `ΤΕΛΟΣ_ΕΠΑΝΑΛΗΨΗΣ`.
...
>
> Στη συνέχεια ελέγχεται η λογική έκφραση και αν δεν ισχύει (είναι `ΨΕΥΔΗΣ`), τότε οι εντολές που βρίσκονται ανάμεσα στις `ΑΡΧΗ_ΕΠΑΝΑΛΗΨΗΣ` και `ΜΕΧΡΙΣ_ΟΤΟΥ`, εκτελούνται πάλι. 
>
> Ελέγχεται ξανά η λογική έκφραση και αν δεν ισχύει, επαναλαμβάνεται η εκτέλεση των ίδιων εντολών. 
>
> Όταν η λογική έκφραση γίνει `ΑΛΗΘΗΣ`, τότε σταματάει η επανάληψη και εκτελείται η εντολή μετά από την `ΜΕΧΡΙΣ_ΟΤΟΥ`.
...
> Πολύ συχνά η ίδια επαναληπτική διαδικασία μπορεί να γραφεί εξίσου σωστά χρησιμοποιώντας είτε τη δομή `ΟΣΟ…ΕΠΑΝΑΛΑΒΕ` είτε τη δομή `ΜΕΧΡΙΣ_ΟΤΟΥ` και είναι προσωπική επιλογή του προγραμματιστή ποια από τις δυο θα χρησιμοποιήσει. 
>
...
> Πολύ συχνά ο αριθμός των επαναλήψεων που πρέπει να εκτελεστούν είναι γνωστός από την αρχή. 
> 
> Αν και αυτού του είδους οι επαναλήψεις μπορούν να αντιμετωπιστούν με τη χρήση των προηγούμενων εντολών επανάληψης, η ΓΛΩΣΣΑ διαθέτει και την εντολή `ΓΙΑ`. 
> 
> Η εντολή αυτή χειρίζεται μια μεταβλητή, στην οποία αρχικά εκχωρείται η αρχική τιμή. 
>
> Η τιμή της μεταβλητής συγκρίνεται με την τελική τιμή και εφόσον είναι μικρότερη από αυτή, τότε εκτελούνται οι εντολές που βρίσκονται στο βρόχο (ανάμεσα στις εντολές `ΓΙΑ` και `ΤΕΛΟΣ_ΕΠΑΝΑΛΗΨΗΣ`). 
>
> Στη συνέχεια η μεταβλητή ελέγχου αυξάνεται κατά την τιμή που ορίζει το `ΒΗΜΑ`. 
>
> Αν η νέα τιμή είναι μικρότερη της τελικής, τότε ο βρόχος εκτελείται ξανά. 
>
> Η διαδικασία αυτή επαναλαμβάνεται συνεχώς, έως ότου η τιμή ελέγχου γίνει μεγαλύτερη της τελικής τιμής, οπότε τερματίζεται η επανάληψη και το πρόγραμμα συνεχίζει με την εντολή που ακολουθεί το `ΤΕΛΟΣ_ΕΠΑΝΑΛΗΨΗΣ`.
>
...
> Στην εντολή αυτή χρησιμοποιείται μια `<μεταβλητή>` στην οποία αρχικά καταχωρίζεται η `<τιμή1>`. 
>
> Η τιμή που παίρνει η `<μεταβλητή>` συγκρίνεται με τη `<τιμή2>` και εφόσον είναι μικρότερη ή ίση από αυτή, τότε εκτελούνται οι εντολές που βρίσκονται στον βρόχο.
>
> Στη συνέχεια, η μεταβλητή αυξάνεται κατά την τιμή χ που ορίζει το `ΒΗΜΑ`. 
>
> Αν η νέα τιμή είναι μικρότερη ή ίση της τελικής, τότε ο βρόχος εκτελείται ξανά. 
>
> Η διαδικασία επαναλαμβάνεται μέχρι η `<μεταβλητή>` να πάρει τιμή μεγαλύτερη από την `<τιμή2>` αλλιώς το πρόγραμμα συνεχίζει με την εντολή μετά το «`ΤΕΛΟΣ_ΕΠΑΝΑΛΗΨΗΣ`».
>
...
> Πολύ συχνά για την επίλυση των προβλημάτων απαιτείται η χρήση εμφωλευμένων βρόχων. 
>
> Σε αυτή την περίπτωση ο ένας βρόχος βρίσκεται μέσα στον άλλο. 
> Στη χρήση των εμφωλευμένων βρόχων ισχύουν συγκεκριμένοι κανόνες που πρέπει να ακολουθούνται αυστηρά για τη σωστή λειτουργία των προγραμμάτων. Συγκεκριμένα:
>
...
> **ΟΛΙΣΘΗΣΗ (shift)**: Στα κυκλώματα του υπολογιστή τα δεδομένα αποθηκεύονται με δυαδική μορφή, δηλαδή `0` και `1`, ανεξάρτητα από το πώς τα ορίζει ο προγραμματιστής, όπως ακεραίους ή πραγματικούς σε δεκαδικό σύστημα, ή ακόμη χαρακτήρες κ.λπ. 
>
> Έτσι ο αριθμός `17` του δεκαδικού συστήματος ισοδυναμεί με τον αριθμό `00010001` του δυαδικού συστήματος, ο οποίος μπορεί να αποθηκευθεί σε ένα `byte`. 
>
...
- [Θέματα](https://apps1.minedu.gov.gr/themata/them_plir_kat_c_hmer_no_0601.pdf)
- [Θέματα επαναληπτικών](http://dide.ilei.sch.gr/keplinet/education/docs/them_plir_kat_c_hmer_epan_0601.pdf)
...
- [Θέματα](https://apps1.minedu.gov.gr/themata/them_plir_kat_c_hmer_no_0602.pdf)
...
- [Θέματα](https://apps1.minedu.gov.gr/themata/them_plir_kat_c_hmer_no_0603.pdf)
- [Θέματα επαναληπτικών](https://apps1.minedu.gov.gr/themata/them_plir_kat_c_hmer_epan_0603.pdf)
...
- [Θέματα](https://apps1.minedu.gov.gr/themata/them_plir_kat_c_hmer_no_0604.pdf)
- [Θέματα επαναληπτικών](https://apps1.minedu.gov.gr/themata/them_plir_kat_c_hmer_epan_0604.pdf)
- [Θέματα Εσπερινών](https://apps1.minedu.gov.gr/themata/them_plir_kat_d_esp_no_0604.pdf)
...
- [Θέματα](https://apps1.minedu.gov.gr/themata/them_plir_kat_c_hmer_no_0605.pdf)
- [Θέματα επαναληπτικών](https://apps1.minedu.gov.gr/themata/them_plir_kat_c_hmer_epan_0705.pdf)
- [Θέματα Εσπερινών](https://apps1.minedu.gov.gr/themata/them_plir_kat_d_esp_epan_0705.pdf)
...
- [Θέματα](https://apps1.minedu.gov.gr/themata/them_plir_c_kat_hmer_no_060530.pdf)
- [Θέματα επαναληπτικών](https://apps1.minedu.gov.gr/themata/them_plir_c_kat_hmer_epan_060706.pdf)
- [Θέματα Εσπερινών](https://apps1.minedu.gov.gr/themata/them_plir_d_kat_esp_epan_060704.pdf)
...
- [Θέματα](https://apps1.minedu.gov.gr/themata/them_plir_c_kat_hmer_no_070531.pdf)
- [Θέματα επαναληπτικών](https://apps1.minedu.gov.gr/themata/them_plir_c_kat_hmer_epan_070704.pdf)
...
- [Θέματα](https://apps1.minedu.gov.gr/themata/them_plir_kat_c_hmer_no_0806.pdf)
- [Θέματα επαναληπτικών](https://apps1.minedu.gov.gr/themata/them_plir_kat_c_hmer_epan_0806.pdf) [Λύσεις](https://aepp.edu.gr/files/lyseis_aepp_2008_epanaliptikes.pdf)
...
- [Θέματα](https://apps1.minedu.gov.gr/themata/them_plir_kat_c_hmer_no_0906.pdf) [Λύσεις](https://aepp.edu.gr/files/lyseis_aepp_2009.pdf)
- [Θέματα επαναληπτικών](https://apps1.minedu.gov.gr/themata/them_plir_kat_c_hmer_epan_0906.pdf) [Λύσεις](https://aepp.edu.gr/files/lyseis_aepp_2009_epanaliptikes.pdf)
...
- [Θέματα](https://aepp.edu.gr/files/aepp_2010_imerisia.pdf) [Λύσεις](https://aepp.edu.gr/files/lyseis_aepp_2010.pdf)
- [Θέματα επαναληπτικών](https://aepp.edu.gr/files/aepp_2010_imerisia_epanaliptikes.pdf) [Λύσεις](https://aepp.edu.gr/files/lyseis_aepp_2010_epanaliptikes.pdf)
...
- [Θέματα](https://aepp.edu.gr/files/aepp_2011_imerisia.pdf) [Λύσεις](https://aepp.edu.gr/files/lyseis_aepp_2011.pdf)
- [Θέματα επαναληπτικών](https://aepp.edu.gr/files/aepp_2011_imerisia_epanaliptikes.pdf) [Λύσεις](https://aepp.edu.gr/files/lyseis_aepp_2011_epanaliptikes.pdf)
...
- [Θέματα](https://aepp.edu.gr/files/aepp_2012_imerisia.pdf) [Λύσεις](https://aepp.edu.gr/files/lyseis_aepp_2012.pdf)
- [Θέματα επαναληπτικών](https://aepp.edu.gr/files/aepp_2012_imerisia_epanaliptikes.pdf) [Λύσεις](https://aepp.edu.gr/files/lyseis_aepp_2012_epanaliptikes.pdf)
...
- [Θέματα](https://aepp.edu.gr/files/aepp_2013_imerisia.pdf) [Λύσεις](https://aepp.edu.gr/files/lyseis_aepp_2013.pdf)
- [Θέματα Εσπερινών](https://aepp.edu.gr/files/aepp_2013_esperina.pdf) [Λύσεις](https://aepp.edu.gr/files/lyseis_aepp_2013_esperina.pdf)
- [Θέματα επαναληπτικών](https://aepp.edu.gr/files/aepp_2013_imerisia_epanaliptikes.pdf) [Λύσεις](https://aepp.edu.gr/files/lyseis_aepp_2013_epanaliptikes.pdf)
...
- [Θέματα](https://aepp.edu.gr/files/aepp_2014_imerisia.pdf) [Λύσεις](https://aepp.edu.gr/files/lyseis_aepp_2014.pdf)
- [Θέματα επαναληπτικών](https://aepp.edu.gr/files/aepp_2014_imerisia_epanaliptikes.pdf) [Λύσεις](https://aepp.edu.gr/files/lyseis_aepp_2014_epanaliptikes.pdf)
...
- [Θέματα](https://aepp.edu.gr/files/aepp_2015_imerisia.pdf) [Λύσεις](https://aepp.edu.gr/files/lyseis_aepp_2015.pdf)
- [Θέματα επαναληπτικών](https://aepp.edu.gr/files/aepp_2015_imerisia_epanaliptikes.pdf) [Λύσεις](https://aepp.edu.gr/files/lyseis_aepp_2015_epanaliptikes.pdf)
...
- [Θέματα (παλιό σύστημα)](https://www.minedu.gov.gr/publications/docs2016/EXETASEIS-2016/them_plir_kat_c_hνέοmer_os_160527.pdf [Λύσεις](https://aepp.edu.gr/files/lyseis_aepp_2016_palaio.pdf)
- [Θέματα (νέο σύστημα)](https://www.minedu.gov.gr/publications/docs2016/EXETASEIS-2016/them_plir_op_c_hmer_ns_160527.pdf) [Λύσεις](https://aepp.edu.gr/files/lyseis_aepp_2016_neo.pdf)
- [Θέματα ομογενών](https://drive.google.com/file/d/0Bx_ILDAH7qb3emJJX2diTTdSbWc/view) [Λύσεις](https://drive.google.com/file/d/0Bx_ILDAH7qb3UTRFdkgxajRHN00/view)
- [Θέματα επαναληπτικών (παλιό σύστημα)](https://aepp.edu.gr/files/aepp_2016_imerisia_palaio_epanaliptikes.pdf) [Λύσεις](https://aepp.edu.gr/files/lyseis_aepp_