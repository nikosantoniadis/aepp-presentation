...
> Κάθε αλγόριθμος απαραίτητα ικανοποιεί τα επόμενα κριτήρια (συνέχεια):
...
> Η Πληροφορική μπορεί να ορισθεί ως η επιστήμη που μελετά τους αλγορίθμους από τις ακόλουθες σκοπιές (συνέχεια):
